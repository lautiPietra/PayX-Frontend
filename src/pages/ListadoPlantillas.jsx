    ...
    return (
        <>
            ...
            <div className="listado-container">
                ...
                <h1 className="listado-titulo">Plantillas de Notificación</h1>
                <p className="listado-subtitulo">
                    Administra los mensajes automáticos que el sistema envía a los usuarios
                </p>
                    ...
                    <div className="listado-body">
                        ...
                        <div className="listado-top-bar">
                            <div className="buscador">
                                <IconSearch size={16} className="buscador-icono" />
                                <input
                                    type="text"
                        ...
                        {!cargando && !error && plantillasFiltradas.length === 0 && (
                            <div className="sin-resultados">
                                <IconSearch size={28} className="sin-resultados-icono" />
