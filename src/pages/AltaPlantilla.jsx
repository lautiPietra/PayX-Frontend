            ...
            <div className="alta-plantilla-container">
                ...
                <div className="alta-plantilla-card">
                    <div className="alta-plantilla-header">
                        <h1 className="alta-plantilla-titulo">Nueva plantilla de notificación</h1>
                        <p className="alta-plantilla-subtitulo">
                            Creá un mensaje automático que el sistema podrá enviar a los usuarios
                        </p>
                    </div>
